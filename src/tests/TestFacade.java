...
/**
 * This creates an easier interface to interact with JUnit 4.
 *
 * @author Josh Archer
 * @version 1.0
 */
...
{
	/**
	 * Hides the Assert.assertEquals() method and follows the same rules as that
	 * method.
	 *
	 * @param message
	 *            the message to print out if the test fails
	 * @param expected
	 *            the expected value
	 * @param actual
	 *            the actual value
	...
	/**
	 * Hides the Assert.assertNotEquals() method and follows the same rules as that
	 * method.
	 *
	 * @param message
	 *            the message to print out if the test fails
	...
	/**
	 * Hides the Assert.assertTrue() method and follows the same rules as that
	 * method.
	 *
	 * @param message
	 *            the message to print out if the test fails
	...
	/**
	 * Hides the Assert.assertFalse() method and follows the same rules as that
	 * method.
	 *
	 * @param message
	 *            the message to print out if the test fails
	...
	/**
	 * Hides the Assert.fail() method and follows the same rules as that method.
	 *
	 * @param message
	 *            the message to display with the test failure
	 */
